...
This game was created by 7 members for a group project during university. Lunar Odyssey is a 2D side-scrolling endless survival game where the player has to avoid obstacles generated by the Greek gods. The controls is using the mouse to drag the moon vertically up and down to control the tide of the waves. Dragging the boat horizontally from left to right would move the boat. I have used what I have learned from the module called Games Studio to implement gameplay such as:
